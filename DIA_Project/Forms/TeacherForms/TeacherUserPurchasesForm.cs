...
{
    public partial class TeacherUserPurchasesForm : Form
    {
        public TeacherUserPurchasesForm(Users u)
        {
            InitializeComponent();
            CurrentUser = u;
            LoadingDataSources();
        ...
        {
            Program.TF.OpenChildForm(new TeacherClassesForm(Program.TF.CurrentTeacher));
        }
